"""
Standalone DAG for Products dataset ETL
"""
...
dag = DAG(
    ...
    description='ETL pipeline for Products dataset',
...
wait_for_file = FileSensor(
    ...
    filepath='/opt/hadoop/data/raw/olist_products_dataset/year={{ ds[:4] }}/month={{ ds[5:7] }}/day={{ ds[8:10] }}/_SUCCESS',
    poke_interval=60,
    timeout=3600,
    dag=dag,
)
