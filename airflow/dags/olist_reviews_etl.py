"""
Standalone DAG for Reviews dataset ETL
"""
...
dag = DAG(
    ...
    description='ETL pipeline for Reviews dataset',
...
wait_for_file = FileSensor(
    task_id='wait_for_reviews_file',
    filepath='/opt/hadoop/data/raw/olist_order_reviews_dataset/year={{ ds[:4] }}/month={{ ds[5:7] }}/day={{ ds[8:10] }}/_SUCCESS',
    poke_interval=60,
    timeout=3600,
    dag=dag,
)
